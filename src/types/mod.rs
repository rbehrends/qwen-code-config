...
pub(crate) use domain::{
    ...
    ImportantOptions, McpServerEntry, McpTransport, ModelEntry, OpenCodeCompatibilityStatus,
    ProviderDraftProfile, ProviderPreset, ReasoningEffort, ReasoningMode, SupportedProtocol,
};
